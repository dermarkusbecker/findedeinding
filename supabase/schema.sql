...
create table if not exists public.clarity_questions (
  ...
  guidance_text text not null default '' check (char_length(guidance_text) <= 4000),
  default_guidance_text text not null default '' check (char_length(default_guidance_text) <= 4000),
  completion_criteria text not null default '' check (char_length(completion_criteria) <= 4000),
  default_completion_criteria text not null default '' check (char_length(default_completion_criteria) <= 4000),
