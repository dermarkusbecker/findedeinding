...
test('Kundennavigation trennt Überblick, Betreuung, Zugang, Kommunikation und Finanzen', async () => {
  ...
  for (const page of ['dashboard', 'login', 'documents', 'conversation', 'account', 'billing', 'messages', 'whatsapp', 'appointments']) assert.match(html, new RegExp(`data-customer-page="${page}"`));
