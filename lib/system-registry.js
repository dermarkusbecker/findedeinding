...
export function buildSystemRegistry({ googleConfigured = false, googleConnection = null, openaiConfigured = false, openaiModel = 'gpt-5.6-terra', checkedAt = new Date().toISOString() } = {}) {
  ...
  const integrations = [
    ...
    {
      id: 'crm_email', name: 'CRM E-Mail', icon: '@', category: 'Kommunikation',
      purpose: 'Bündelt später den ein- und ausgehenden Mailverkehr direkt in der Kundenakte.',
      detail: 'Schnittstelle ist als nächster Ausbau vorgesehen.', status: PLANNED,
    },
    {
  ...
  const agents = [
    ...
    {
      id: 'decision_escalation', name: 'Entscheidungs- & Eskalationsagent', icon: 'E', phase: 'Woche 7',
      situation: 'Soll Entscheidungssicherheit erkennen und bei festgefahrenen Situationen einen Coach-Fall vorbereiten.',
      tool: 'Geplanter Spezialagent', detail: 'Fachlogik und Übergaberegeln werden separat umgesetzt.', status: PLANNED,
    },
    {
