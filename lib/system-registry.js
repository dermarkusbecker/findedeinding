...
export function buildSystemRegistry({ googleConfigured = false, googleConnection = null, googleMeetRecordingReady = false, openaiConfigured = false, openaiModel = 'gpt-5.6-terra', whatsappConfigured = false, checkedAt = new Date().toISOString() } = {}) {
  ...
  const integrations = [
    ...
    },
    {
      ...
      purpose: 'Erstellt Meet-Links und übernimmt native Meet-Aufzeichnungen sicher in die Vertragsakte.',
