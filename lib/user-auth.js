...
export async function provisionProgramUser(config, { name, email: emailInput, phone = '', startDate, sourceLeadId = null, permissions = ['customer_portal', 'clara_program', 'documents'] }) {
