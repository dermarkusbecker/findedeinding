...
const actionTypes = [
  ...
  'save_guided_answer', 'correct_guided_answer',
];
      ...
      type: 'array', maxItems: 3, items: {
        ...
        properties: { action: { type: 'string', enum: actionTypes }, payload: {
          ...
          properties: {
            ...
            step_id: { type: ['string', 'null'], maxLength: 100 }, items: { type: ['array', 'null'], items: { type: 'string', maxLength: 1000 }, maxItems: 20 }, confirmed_none: { type: ['boolean', 'null'] },
          },
          required: ['wishes', 'wish_index', 'wish', 'answer', 'score', 'reason', 'source', 'confirmed', 'complete', 'step_id', 'items', 'confirmed_none'],
        } },
