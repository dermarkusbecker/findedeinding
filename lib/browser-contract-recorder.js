...
export class ContractRecorder {
  ...
  controls() {
    ...
    this.retry.textContent = this.partialUpload ? "Speichern erneut versuchen" : "Video speichern";
  ...
  async begin() {
    ...
    try {
      ...
      this.recorder.onstop = () => {
        ...
        this.busy = false;
        this.status("Aufnahme bereit. Prüfe Bild und beide Stimmen in der Vorschau, dann klicke auf Video speichern.", "", "VORSCHAU");
        this.controls();
      };
      display
        .getVideoTracks()[0]
