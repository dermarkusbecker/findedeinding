...
export async function handleCustomerRecords(request, response) {
  ...
  const required = action === 'whatsapp-send' ? ['communications', 'customers'] : action.startsWith('document') || action === 'avatar-upload' ? ['customers', 'program'] : ['customers', 'finance', 'communications', 'sales_calls'];
